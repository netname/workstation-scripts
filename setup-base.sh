...
echo ""
echo "Next step — run the bootstrap:"
echo "  bash <(wget -qO- https://raw.githubusercontent.com/YOURUSER/workstation-scripts/main/bootstrap.sh)"
echo ""
echo "Replace YOURUSER with your GitHub username."
echo "The bootstrap handles SSH key generation automatically."
